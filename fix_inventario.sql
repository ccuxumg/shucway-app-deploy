-- Script para corregir todas las funciones y triggers de inventario
-- Ejecutar este script en la base de datos para solucionar el error de tabla "inventario" no existe
