...
export default function RecepcionMercaderia() {
  ...
  const totalPages = Math.ceil(filteredRecepciones.length / pageSize);
                    ...
                    <div className="bg-white rounded-lg max-w-3xl w-full p-6">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <div className="font-medium">{selectedRecepcion.orden_compra?.numero_orden || '-'}</div>
                        </div>
                        <div>
                    ...
                    <tr key={recepcion.id_recepcion} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() => navigate(`/inventario?tab=recepciones&editRecepcion=${recepcion.id_recepcion}`)}
